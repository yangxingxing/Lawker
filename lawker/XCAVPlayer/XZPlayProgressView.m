...
- (void)resetAllSubviews{
    ...
    _fullBtn2 = [UIButton buttonWithType:UIButtonTypeCustom];
    _fullBtn2.backgroundColor = [UIColor clearColor];
    //[self addSubview:_fullBtn2];
    [_fullBtn2 setImage:[UIImage imageNamed:@"on11"] forState:UIControlStateNormal];
    
    _fullBtn3 = [UIButton buttonWithType:UIButtonTypeCustom];
    _fullBtn3.backgroundColor = [UIColor clearColor];
    //[self addSubview:_fullBtn3];
    [_fullBtn3 setImage:[UIImage imageNamed:@"2xx"] forState:UIControlStateNormal];
...
//    [_fullBtn2 mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.top.equalTo(self.mas_top).with.offset(10.0);
//        make.bottom.equalTo(self.mas_bottom).with.offset(-10.0);
//        make.width.equalTo(_fullBtn2.mas_height);
//        make.left.equalTo(_totalDurationLabel.mas_right).with.offset(10.0);
//    }];
//    
//    [_fullBtn3 mas_makeConstraints:^(MASConstraintMaker *make) {
//        make.top.equalTo(self.mas_top);
//        make.bottom.equalTo(self.mas_bottom);
//        make.width.equalTo(_fullBtn3.mas_height);
//        make.left.equalTo(_fullBtn2.mas_right).with.offset(5.0);
//    }];

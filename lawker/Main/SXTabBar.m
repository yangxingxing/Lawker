...
- (void)addBarButtonWithNorName:(NSString *)nor andDisName:(NSString *)dis andTitle:(NSString *)title
{
    ...
    [btn setTitleColor:[UIColor colorWithRed:28/255.0 green:77/255.0 blue:151/255.0 alpha:1] forState:UIControlStateDisabled];
...
- (void)layoutSubviews
{
    ...
    for (int i = 1; i<self.subviews.count; i++) { // $$$$$
        ...
        CGFloat btnW = [UIScreen mainScreen].bounds.size.width/(self.subviews.count - 1);
        CGFloat btnH = 49;
